...
*** Scheme Mode
 - Is there an Emacs mode for Scheme? Emacs comes with two Scheme modes. Most
   people prefer the one that is not the default. To switch to that mode, put

...
#+author:LOLH
#+date:2021-11-23 09:12
#+macro:version Version 0.0.119
...
book[fn:11] does emphasize a  side-effect-free, applicative approach to
...
[fn:11]In the browser, add =index.text= to the end of the URL to see the source.

[fn:12]Markdown requires the standard Perl library module Digest::MD5.
# Local Variables:
# fill-column: 79
# eval: (auto-fill-mode)

...
sacri- ficing Common Lisp’s trademark interactive style of development.
** Sly
...
** eglot
``A client for Language Server Protocol servers''[fn:7]
...
- [[Mac OS X Dictionary.app interface for Emacs][GitHub Source]]
...
book[fn:19] does emphasize a  side-effect-free, applicative approach to
...
- [[https://blog.cddr.org][the fe[nl]ix blog]][fn:20]
...
[fn:7] https://microsoft.github.io/language-server-protocol/overviews/lsp/overview/
...
[fn:19] In  the browser,  add =index.text=  to the end  of the  URL to  see the
source.

[fn:20]Built with [[http://www.gohugo.io/][Hugo]], using the theme [[https://gitlab.com/ian-s-mcb/smigle-hugo-theme][smigle]], which was influenced by the theme [[https://github.com/sumnerevans/smol][smol]].

[fn:21] Markdown requires the standard Perl library module Digest::MD5.
# Local Variables:
# fill-column: 79
# eval: (auto-fill-mode)

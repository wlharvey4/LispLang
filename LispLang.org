...
- M-x slime ::
  Run SLIME  and connect to an  inferior Lisp. SLIME will  now automatically be
  available in your Lisp source buffers.
  : =M-x slime=
...
** Using SLIME
- =slime-mode= ::  SLIME’s commands are  provided via slime-mode,  a minor-mode
